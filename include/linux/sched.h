...
#define TASK_INTERRUPTIBLE		0x0001	/* 睡眠状态 */
#define TASK_UNINTERRUPTIBLE		0x0002	/* 因内核指示而停用的睡眠进程，只能由内核亲自唤醒 */
#define __TASK_STOPPED			0x0004	/* 表示进程特意停止运行，比如调试器暂停 */
#define __TASK_TRACED			0x0008	/* 使用ptrace调试的进程 */
